const initialPortfolio = [
  ...
  // },
  {
    id: 2,
    mixitup: 'mix web',
    img: 'img/works/basketPlace.png',
    title: 'Frontend разработка',
    subtitle: 'Basket Place',
    imgSource: './icons/social/github.svg',
    titleSource: 'GitHub',
    linkSource: 'https://github.com/UDanV/basket-Place',
    linkWeb: ' -> // <- ',
  },
  {
    id: 25,
    mixitup: 'mix web',
    img: 'img/works/info.png',
    title: 'Графический дизайн',
  ...
  },
  {
    ...
    imgSource: './icons/social/github.svg',
    titleSource: 'GitHub',
    linkSource: 'https://github.com/UDanV/portfolio',
    linkWeb: ' -> // <- ',
  },
];
